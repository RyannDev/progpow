Contributing to cmt Core
============================

The cmt Core project operates an open contributor model where anyone is
...
The following applies to code changes to the cmt Core project, and is not to be
confused with overall cmt Network Protocol consensus changes.

Whether a pull request is merged into cmt Core rests with the project merge
...
Patches that change cmt consensus rules are considerably more involved than
...
Where a patch set proposes to change the cmt consensus, it must have been
...
The project leader is the release manager for each cmt Core release.
