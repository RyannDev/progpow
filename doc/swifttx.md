...
This mechanism has been integrated into Bitcore-Node-cosmitto which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/cosmitto-Project/insight-api-cosmitto#web-socket-api](https://github.com/cosmitto-Project/insight-api-cosmitto#web-socket-api)
* API: [https://github.com/cosmitto-Project/insight-api-cosmitto#hypersend-transactions](https://github.com/cosmitto-Project/insight-api-cosmitto#hypersend-transactions)
...
By default, the cosmitto Core daemon will launch using the following constant:

```
static const int DEFAULT_HYPERSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the cosmitto Core daemon:
