...
In order to support loading of multiple wallets in cosmitto-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cosmitto.cpp.
...
Changes to cosmitto.cpp
----------------------
cosmitto.cpp is the entry point into cosmitto-qt, and as such, will require some minor modifications to provide hooks for
