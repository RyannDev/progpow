...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 55500;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // cosmitto starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // cosmitto: 1 day
        nTargetSpacing = 1 * 60;  // cosmitto: 1 minute
        nMaturity = 29;
        ...
        const char* pszTimestamp = "30th October 2017 - cosmitto - The day you'll remember.";
        ...
        vSeeds.push_back(CDNSSeedData("mainseed.cosmittoseednodes.org", "mainseed.cosmittoseednodes.org"));
        vSeeds.push_back(CDNSSeedData("mainseed2.cosmittoseednodes.org", "mainseed2.cosmittoseednodes.org"));
...
public:
    CTestNetParams()
    {
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 83); // Testnet cosmitto addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 18);  // Testnet cosmitto script addresses start with '8' or '9'
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // cosmitto: 1 day
        nTargetSpacing = 1 * 60;        // cosmitto: 1 minutes
